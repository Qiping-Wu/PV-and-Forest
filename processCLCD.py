...
def main(argv):
    input_dir='/dat1/PV and forest/CLCD2020'
    outpath='/dat1/qiping_data/PV And Forest/WSP_LULC/CLCD2020/'
    clip_buf2km='/dat1/qiping_data/PV And Forest/CN_prj_buf2km.shp' 
    clip_CN='/dat1/qiping_data/PV And Forest/CN_prj.shp'
     
    tif_file=input_dir+'/CLCD_v01_2020_albert.tif'
    resample_outpath=outpath+'CLCD30_Resample.tif'
    ...
    clip1_outpath = outpath+"CLCD_buf2km.tif"
    clip2_outpath = outpath+"CLCD_CN.tif"
