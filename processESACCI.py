...
def main(argv):
    input_dir='/dat1/PV and forest/ESA_CCI'
    outpath='/dat1/qiping_data/PV And Forest/WSP_LULC/ESA_CCI/'
    clip_buf2km='/dat1/qiping_data/PV And Forest/CN_prj_buf2km.shp' 
    clip_CN='/dat1/qiping_data/PV And Forest/CN_prj.shp'
     
    tif_file=input_dir+'/ESACCI2020.tif'
    
    resample_outpath=outpath+'ESACCI_Resample.tif'
    ...
    clip1_outpath = outpath+"ESACCI_buf2km.tif"
    clip2_outpath = outpath+"ESACCI_CN.tif"
