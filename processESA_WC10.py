...
def main(argv):
    input_dir='/dat1/PV and forest/ESA_WorldCover10_2020'
    outpath='/dat1/qiping_data/PV And Forest/WSP_LULC/ESA_WC10/'
    ...
    merge_options=gdal.WarpOptions(format='GTiff',resampleAlg='near',srcNodata=0, dstNodata=0,creationOptions=["COMPRESS=LZW","BIGTIFF=YES"])
    merge_outpath=outpath+'ESAWC10_Mrg.tif'
    gdal.Warp(merge_outpath, tif_files,options=merge_options)
    
    resample_outpath=outpath+'ESAWC30_Resample.tif'
    ...
    clip1_outpath = outpath+"ESAWC30_buf2km.tif"
    clip2_outpath = outpath+"ESAWC30_CN.tif"
