...
def main(argv):
    input_dir='/dat1/PV and forest/Esri10_2020'
    outpath='/dat1/qiping_data/PV And Forest/WSP_LULC/Esri10/'
    ...
    merge_outpath=outpath+'Esri10_Mrg.tif'
    gdal.Warp(merge_outpath, tif_files,options=merge_options)
    
    resample_outpath=outpath+'Esri30_Resample.tif'
    ...
    clip1_outpath = outpath+"Esri30_buf2km.tif"
    clip2_outpath = outpath+"Esri30_CN.tif"
