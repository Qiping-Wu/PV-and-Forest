...
def main(argv):
    input_dir='/dat1/PV and forest/GLC-FCS2020'
    outpath='/dat1/qiping_data/PV And Forest/WSP_LULC/GLC_FCS2020/'
    ...
    merge_outpath=outpath+'GLCFCS_Mrg.tif'
    gdal.Warp(merge_outpath, tif_files,options=merge_options)
    
    resample_outpath=outpath+'GLCFCS_Resample.tif'
    ...
    clip1_outpath = outpath+"GLCFCS_buf2km.tif"
    clip2_outpath = outpath+"GLCFCS_CN.tif"
